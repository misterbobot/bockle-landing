...
export const HomePage: React.FC = () => {
    return (
        <div className="h-full overflow-hidden relative">
            <a className="absolute text-white top-1/2 left-1/2 transform -translate-x-2/4 -translate-y-2/4 z-20  z-100 flex flex-col items-center hover:scale-105 transition-all duration-300  cursor-pointer" href="/brand/fw24">
